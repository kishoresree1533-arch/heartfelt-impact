          ...
          <div className="grid gap-20 lg:grid-cols-12">
            ...
            <div className="lg:col-span-5">
              ...
              <div className="mt-12 flex flex-col gap-4">
                 <a
                    href="mailto:iraithuligaliyakkam@gmail.com"
                    className="flex items-center gap-4 text-white/30 hover:text-gold transition-colors duration-500"
                  >
                    <Mail className="h-4 w-4" />
                    <span className="text-xs uppercase tracking-widest">iraithuligaliyakkam@gmail.com</span>
                 </a>
